                        ...
                        <tbody>
                            @foreach($orders as $order)
                                        <tr>
                                            ...
                                            <td>Rp. {{ number_format(
                                    $order->total_harga + $order->biaya_ongkir,
                                    0,
                                    ',',
                                    '.'
                                ) }}
                                            ...
                                            <td>
                                                <button class="primary-btn" data-toggle="modal"
                                                    datatarget="#orderDetailModal{{ $order->noresi }}">Lihat Detail</button>
                                                <a href="#">
                                                    <button type="button" class="primary-btn">Invoice</button>
                                                </a>
                                                <!-- Modal -->
                                                <div class="modal fade" id="orderDetailModal{{ $order->noresi }}" tabindex="-1" role="dialog"
                                                    aria-labelledby="orderDetailModalLabel{{ $order->noresi }}" aria-hidden="true">
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="orderDetailModalLabel{{
                                    $order->id }}">Detail Pesanan #{{ $order->noresi }}</h5>
